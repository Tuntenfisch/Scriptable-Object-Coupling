...
namespace Tuntenfisch.ScriptableObjectCoupling.Sets
{
    public abstract class RuntimeSet<T> : ScriptableObject, IEnumerable<T>, ISerializationCallbackReceiver
    {
        ...
        public void Add(T element)
        {
            ...
            {
                Debug.LogWarning($"Tried to add an element to {nameof(RuntimeSet<T>)} that is already contained in the set.", this);
            }
        }
        ...
        public void Remove(T element)
        {
            ...
            {
                Debug.LogWarning($"Tried to remove an element from {nameof(RuntimeSet<T>)} that is not contained in the set.", this);
            }
        }
        #endregion
