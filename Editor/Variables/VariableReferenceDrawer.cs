...
namespace Tuntenfisch.ScriptableObjectCoupling.Variables.Editor
{
    ...
    public class VariableReferenceDrawer : PropertyDrawer
    {
        ...
        private void DisplayVariableProperty(SerializedProperty property, Rect variableRect, GUIContent label)
        {
            ...
            selectedPopupOption = MyEditorGUI.PropertyFieldWithPaneOptions(variableRect, label, m_useLiteralProperty.boolValue ? null : m_variableProperty, selectedPopupOption, s_popupOptions);
        ...
        private Rect GetValueRect(Rect position)
        {
            ...
            return MyEditorGUIUtility.GetIndentedRect(new Rect(position.x, position.y + offset, position.width, position.height - offset), UnityEditor.EditorGUI.indentLevel + 1);
        }
